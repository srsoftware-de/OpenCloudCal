<?php if ($format=='ical') {
    ...
    <?php echo 'OpenCloudCal 0.63.4 - '.str_replace('%link', 'https://github.com/srsoftware-de/OpenCloudCal', loc('Proudly developed using PHP and JavaScript. Find the sources at <a href="%link">Github</a>.')); ?>
