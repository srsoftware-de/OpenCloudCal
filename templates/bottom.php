<?php if ($format=='ical') {
    ...
    <?php echo 'OpenCloudCal 0.55 - '.str_replace('%link', 'https://github.com/keawe-software/OpenCloudCal', loc('Proudly developed using PHP and JavaScript. Find the sources at <a href="%link">Github</a>.')); ?>
    </div>
  </body>
</html>
<?php } ?>
